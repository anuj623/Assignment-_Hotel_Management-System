...
// Corrected imports strictly looking at the unique component filenames
import { ReusableFilter } from './components/ReusableFilter.component';
import { ReusableTable } from './components/ReusableTable.component';
...
export default function App() {
    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial' }}>
            <h2>Hotel Booking Management Modules</h2>
